        ...
        <form class="p-4 border rounded shadow" method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                <div class="flex items-center justify-between">
                    ...
                    <input type="date" name="birth_date" id="birth_date" class=" border p-2 rounded"
            ...
            <div class="mb-4">
                <div class="flex items-center justify-between">
                    ...
                    <input type="number" step="0.1" name="height" id="height" class="border p-2 rounded"
                        value="{{ old('height') }}" placeholder="例：160.5">
                </div>
                @error('height')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                <div class="flex items-center justify-between">
                    ...
                    <input type="number" step="0.1" name="target_weight" id="target_weight"
                        class="border p-2 rounded" value="{{ old('target_weight') }}" placeholder="例：50.5">
                </div>
                @error('target_weight')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <a href="{{ route('login') }}" class="text-right block mt-2 text-blue-500 hover:underline">
                ログインはこちら
            </a>
        </form>
